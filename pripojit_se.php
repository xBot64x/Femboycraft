	...
	<div class="main">
		<div class="main-container">
			<div class="main-content">
                ...
                <p>4. zadejte tuto IP adresu jako adresu serveru:</p>
                <br>
                <p>(klikněte pro zkopírování IP)</p>
                <img src="images/ip.webp" alt="95.82.185.15:25565" id="copyImage" onclick="copyToClipboard()" class="image-btn">
                <div id="Popup"><p>IP zkopírováno</p></div>
		</div>
	</div>	
